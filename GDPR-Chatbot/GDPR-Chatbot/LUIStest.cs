...
{
    [LuisModel("<83680a15-a6c8-4a5a-8b10-a20075a998bc>", "fc5cc1eaa79941ca8abbcab6a2bdf306", domain: "westus.api.cognitive.microsoft.com")]
    [Serializable]
    public class LUIStest : LuisDialog<object>
    {
        ...
        public LUIStest(ILuisService service)
            : base(service)
        {
        }
